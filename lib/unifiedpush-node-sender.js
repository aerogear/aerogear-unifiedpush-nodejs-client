...
/**
    ...
    @param {String}  [message.windows.type] - "title"
    @param {String}  [message.windows.duration] - "short"
    @param {String}  [message.windows.badge] - "alert"
    @param {String}  [message.windows.tileType] - "TileWideBlockText01"
    @param {Array}   [message.windows.images] - ["", ""]
    @param {Array}   [message.windows.textFields] - [""]
