...
function createServerSettings( url, applicationId, masterSecret, customHeaders ) {
    var defaultHeaders = {
...
AeroGear.Sender.prototype.send = function( message, options, callback ) {
    ...
    serverSettings = createServerSettings( url, this.getApplicationId(), this.getMasterSecret(), this.getCustomHeaders() );
