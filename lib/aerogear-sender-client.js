...
AeroGear.sender.prototype.sendTo = function( message, options ) {
    ...
    //TODO: make this more dynamic for different criteria
    newMessage.alias = options.alias;
    newMessage.message = message;

    url = urlParser.parse( this.getUrl() + "selected" );
    serverOptions = createServerOptions( url, options );

    send.call( this, serverOptions, newMessage );
